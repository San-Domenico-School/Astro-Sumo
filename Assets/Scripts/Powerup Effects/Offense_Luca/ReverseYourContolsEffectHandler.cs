...
public class ReverseYourContolsEffectHandler : MonoBehaviour
{
...
private void ApplyEffect(PowerUpData data) 
      {
          ...
          {
              // Changes bool field in Player Movement that carries our behaviors
              playerMovement.controlsReversed = data.reverseYourControls;
